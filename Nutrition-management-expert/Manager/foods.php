...
<div class="container">
	...
	<br />
	<div class="col-lg-12 has-feedback admin-search">
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTable2">
                    ...
                    ?>
                        ...
                        <tr class="">
                            ...
                            <td>
                            <a class="btn btn-info" href="foods_editform.php?edit_id=<?php echo $row['food_id']; ?>" title="Click to edit"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
                            <a class="btn btn-danger" href="?delete_id=<?php echo $row['food_id']; ?>" title="Click to delete" onclick="return confirm('Are you sure you want to delete this?')"><span class="glyphicon glyphicon-remove-circle"></span> Delete</a>
                            </td>
