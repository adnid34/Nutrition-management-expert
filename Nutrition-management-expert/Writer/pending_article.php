	                            ...
	                            <tr href="article_content.php?id=<?php echo $article_writer_id;?>" style = "cursor:pointer;">
	                                <td>
									    <p>
									        ...
									        <span class="pull-right text-muted">0% Aproval (<?php echo time_elapsed_string($timestamp); ?>)</span>
									    </p>
									    <div class="progress progress-striped active">
									        <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="width: 0%">
									        </div>
									    </div>
	                                </td>
	                            </tr>
                    		...
                    		?>
	                            <tr href="article_content.php?id=<?php echo $article_writer_id;?>" style = "cursor:pointer;">
	                                <td>
									    <p>
									        <strong><?php echo $title; ?></strong> 
									        <span class="pull-right text-muted">50% Aproval (<?php echo time_elapsed_string($timestamp); ?>)</span>
									    </p>
									    <div class="progress progress-striped active">
									        <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="width: 50%">
									        </div>
									    </div>
	                                </td>
	                            </tr>
